...
class CouvertureDragger extends StatefulWidget {
  ...
  @override
  _CouvertureDraggerState createState() => new _CouvertureDraggerState();
}

class _CouvertureDraggerState extends State<CouvertureDragger> {
